...
const Header = () => {
  ...
  // const { userId, fetchUserFromDb, user } = useUserStore();
  ...
  //   };
  //   getUser();
  // }, [userId, fetchUserFromDb]);

  return (
    <header className="bg-web-bg-dark border-b border-web-primary-dark shadow-md">
          ...
          {/* <div className="flex flex-col items-end">
            {user ? (
              <>
                ...
                <p className="text-xl font-bold  text-custom-gray ">{`${user.credit} บาท`}</p>
              </>
            ) : (
              <span
